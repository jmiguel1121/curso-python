...
'''
Espacio para subir código Python ejercicio Guía
Borrador
Actividad 5: Modelo ML
Borrador
Reflexión
Borrador
Clase 7 - Evaluación Final
Clase 7 - Evaluación Final
Relación grupos de trabajo y asignación actividad 5
Borrador
Planilla de notas a reportar a SINU
Borrador
Notas finales - Ajustado 22 dic 2: 40 p.m.
Borrador
Planilla Reporte a registro sistema SINU - Ajustado 22 dic 2022 14: 50
Borrador
'''
# Declarando arreglo
lista = list(range(10))
